...
const faqData = [
  ...
  { q: "How long until I see results?", a: "Most clients start booking calls within 30 to 90 days, and it compounds from there. YouTube builds, it doesn't spike overnight. Anyone promising an exact number by an exact day is guessing." },
